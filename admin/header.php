...
<head>
    <title>Sistem Informasi Pendataan Masyaraka Tidak Mampu </title>

 <link rel="stylesheet" type="text/css" href="../assets/css/jquery.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/bootstrap.css">
    <script type="text/javascript" src="../assets/js/jquery.js"></script>
    <script type="text/javascript" src="../assets/js/bootstrap.js"></script>
<script type="text/javascript" src="../assets/js/jquery-3.5.1.js
"></script>
    ...
    <nav class="navbar navbar-inverse" style="border-radius: 0px">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">SIPMTM </a>
            </div>

            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class=""><a href="index.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a></li>
                    <li><a href="penduduk.php"><i class="glyphicon glyphicon-user"></i> Penduduk</a></li>
                     <li><a href="lingkungan.php"><i class="glyphicon glyphicon-map-marker"></i> Lingkungan</a></li>
                 
                    <li><a href="lapor.php"><i class="glyphicon glyphicon-list-alt"></i> Laporan</a></li>
                    <li class="dropdown">
